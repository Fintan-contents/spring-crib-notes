...
:spring-framework-doc:`Spring Web MVC <web/webmvc.html>` では、発生した例外を自動的にログ出力し、クライアントにエラーを返却します。

:spring-framework-javadoc:`Spring Web MVCがデフォルトでハンドリングする例外 <javadoc-api/org/springframework/web/servlet/mvc/support/DefaultHandlerExceptionResolver.html>`
...
-----------------------------------------------------------------------------
アプリケーション全体で例外に応じた処理が決まっている場合は、\ :spring-framework-javadoc:`@ControllerAdvice <javadoc-api/org/springframework/web/bind/annotation/ControllerAdvice.html>`
...
また、返却するステータスコードは :spring-framework-javadoc:`@ResponseStatus <javadoc-api/org/springframework/web/bind/annotation/ResponseStatus.html>` アノテーションに設定します。
