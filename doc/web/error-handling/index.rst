...
このため、アプリケーション側で何かを作り込み必要はありませんが、例外に応じてクライアントに返すステータスコードやページを変更したい場合には例外ハンドリングを実装する必要があります。

例外に応じてクライアントに返すステータスコードやページをカスタマイズする例
-----------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------
:ref:`database-validation` の例を参照してください。
